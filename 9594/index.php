...
<td class="menu"><div class="menuSub" id="menuSub01" style="border-radius: 0px 10px 0px 0px;" onclick="changeTab(0, 1, 3);" onMouseOver="tabRollOverIn(0, 1, 'menuSubHighlight');" onMouseOut="tabRollOverOut(0, 1, 'menuSub');">Rep. Contacts</div></td>
</tr>
</table>
...
<div>
	<table class="generalElement">
		<tr class="blue">
			<td align="left">Apple Valley Employee Phonebook</td>
			<td align="right"><button onClick="expandInfo('phoneBook');">View Employee Phonebook</button></td>
		</tr>
		<tr class="white" id="phoneBook" style="display: none;">
			<td colspan="3" style="padding: 0px;">
				<table class="nostyle">
					<tr><td><iframe src="phoneBook/phoneBook.pdf" id="iframePhoneBook" frameborder="0" style="width: 100%; height: 400px;">Your browser doesnt support iframes</iframe></td></tr>
				</table>
			</td>
		</tr>
	</table>
...
<div>
	<table class="generalElement">
		...
		<tr class="blue" id="weberInfo" style="display: none;">
			<td colspan="2">
			<table>
...
<div>
	<table class="generalElement">
		<tr class="blue"><td align="left">Rental Item Information</td><td align="right"><button onClick="expandInfo('rentals');">Show Rental Items</button></td></tr>
		<tr class="blue" id="rentals" style="display: none;"><td colspan="2" style="padding: 0px;">
			<table class="rentals">
...
<div>
	<table class="generalElement">
		<tr class="blue"><td align="left"><a href="http://acehardware.woosterbrush.com">Wooster Ace Site</a></td><td align="right"><button onClick="expandInfo('wooster');">More Info</button></td></tr>
		<tr class="blue" id="wooster" style="display: none;"><td colspan="2">No Extra Info Yet</td></tr>
	</table>
</div>
...
<div>
	<table class="generalElement">
		<tr class="white">
		<tr class="blue"><td align="left"><a href=\"homepage.local\www\9594\salescalendar\Sales_Calendar.pdf">Sales Calendar</a></td><tr
		<tr class="white" id="salescalendar/?C=M" style="display: none;"><td colspan="2" style="padding: 0px;">
		</td></tr>
	</table>
</div>
...
<div>
	<table class="generalElement">
		<tr class="blue"><td align="left" colspan="5"><a href="http://radar.weather.gov/ridge/radar.php?product=NCR&rid=MPX&loop=yes">Weather Map (Radar)</a></td></tr>
		<tr class="blue" style="vertical-align: top;"><td align="left" id="currentConditions"></td><td align="left" id="futureConditions1"></td><td align="left" id="futureConditions2"></td><td align="left" id="futureConditions3"></td><td align="left" id="futureConditions4"></td></tr>
	</table>
</div>
...
<div>
	<table class="generalElement">
		<tr class="blue"><td align="left"><a href="https://fusebox.elavon.net/ui/portal.html">Fusebox</a></td><td align="right"><button onClick="expandInfo('fuseBox');">More Info</button></td></tr>
		<tr class="blue" id="fuseBox" style="display: none;"><td colspan="2">
		<table class="nostyle">
...
<div>
	<table class="generalElement">
		<tr class="blue"><td align="left"><a href="http://store6cams.local:7000">Bloomington Security Cameras</a></td></tr>
	</table>
</div>
...
<tr class="white"><td>Robert-Buck-Buckingham</td><td>NA</td><td>952-212-3790</td><td>bobsandy@frontiernet.net</td></tr>
...
<tr class="white"><td>Mike Thorfinson</td><td>NA</td><td>952-292-1394</td><td>NA</td></tr>
...
<tr class="white"><td>Mike Gournoe</td><td>NA</td><td>612-559-9389</td><td>mmichael97061@hotmail.com</td></tr>
