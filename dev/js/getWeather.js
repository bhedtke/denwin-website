function getWeather(zipCode){
  $.post("php/weather.php", {zipCode : zipCode}, function(returnData){
   ...
   var obj = $.parseJSON(returnData);
     $("#currentConditions").html( "Today<br />Conditions: " + obj.current.condition[0] + "<br />Low: " + obj.future[0].low[0] + " degrees<br />Current: " + obj.current.tempurature[0] + " degrees<br />High: " + obj.future[0].high[0] + " degrees<br />" + obj.current.humidity[0] + "<br />" + obj.current.wind[0]);
